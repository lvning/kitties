...
pub mod pallet {
	...
	pub type OwnerKitties<T: Config> = StorageMap<_, Blake2_128Concat, T::AccountId, BoundedVec<Kitty, T::MaxKittiesOwned>, ValueQuery>;
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn transfer(origin: OriginFor<T>, kitty_id: T::KittyIndex, new_owner: T::AccountId) -> DispatchResult {
			...
			OwnerKitties::<T>::try_mutate(&prev_owner, |owned| {
